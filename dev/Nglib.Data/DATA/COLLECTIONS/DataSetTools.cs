...
{
    /// <summary>
    /// Permet de manipuler des données  DataSet DataTable DataRow DataColumn
    /// </summary>
    public static class DataSetTools
    {
        ...
        /// <summary>
        /// Obtenir une donnée d'un datarow et la transformer en string SAFE (case insensitive)
        /// </summary>
        ...
        /// <summary>
        /// Obtenir une donnée d'un datarow (case insensitive)
        /// </summary>
        ...
        public static System.Data.DataColumn GetColumn(this System.Data.DataTable table, string ColumnName)
        {
            ...
            return table.Columns.ToList().FirstOrDefault(c=> ColumnName.Equals(c.ColumnName, StringComparison.OrdinalIgnoreCase));
        }
        ...
        /// </summary>
        /// <param name="row">row</param>
        /// <param name="includeKeys">retour les primary ou non</param>
        /// <param name="includeValues">retourne les données autre que primarykey ou non</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Permet de copier un row et l'ajouter dans une autre datatable en prenant en compte les contraintes de la nouvelle table
        /// </summary>
        ...
        /// <summary>
        /// Permet de nétoyer une datatable, en mettant les noms de colones en minuscule
        /// </summary>
