...
namespace Nglib.DATA.COLLECTIONS
{
    public static class DataSetTools
    {
        ...
        //public static long GetRowSize(System.Data.DataRow row)
        //{
        //    if(row==null ||row.ItemArray==null) return 0;
        //    long retour = row.ItemArray.ToList().Select(c => Nglib.APP.CODE.ReflectionTools.GetSizeOfObject(c)).Sum();
        //    return retour;
        //}
