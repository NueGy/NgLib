    ...
    public static class ConnectorTools
    {
        ...
        public static System.Data.IDbConnection ConnectionFactory(string engineName)
        {
            ...
            if (engine == ConnectorConstants.ConnectorEngineEnum.MSSQL)
            {
                ...
                if (retour == null) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.SqlClient.SqlConnection, System.Data.SqlClient");
            }
            else if (engine == ConnectorConstants.ConnectorEngineEnum.POSTGRESQL) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("Npgsql.NpgsqlConnection, Npgsql");
            else if (engine == ConnectorConstants.ConnectorEngineEnum.SQLITE) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.SQLite.SQLiteConnection, System.Data.SQLite");
            else if (engine == ConnectorConstants.ConnectorEngineEnum.ORACLE) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.OracleClient.OracleConnection, System.Data.OracleClient");
            else if (engine == ConnectorConstants.ConnectorEngineEnum.ACCESS)
            {
                ...
                if (retour == null) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.OleDb.OleDbConnection, System.Data.OleDb");
                if (retour == null) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.OleDb.OleDbConnection, System.Data, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"); // !!!
            }
        ...
        public static System.Data.IDataAdapter DataAdapterFactory(string engineName, System.Data.IDbCommand cmd)
        {
            ...
            if (engine == ConnectorConstants.ConnectorEngineEnum.MSSQL)
            {
                ...
                if (retour == null) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.SqlClient.SqlDataAdapter, System.Data.SqlClient");
            }
            else if (engine == ConnectorConstants.ConnectorEngineEnum.POSTGRESQL) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("Npgsql.NpgsqlDataAdapter, Npgsql");
            else if (engine == ConnectorConstants.ConnectorEngineEnum.SQLITE) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.SQLite.SQLiteDataAdapter, System.Data.SQLite");
            else if (engine == ConnectorConstants.ConnectorEngineEnum.ORACLE) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.OracleClient.OracleDataAdapter, System.Data.OracleClient");
            else if (engine == ConnectorConstants.ConnectorEngineEnum.ACCESS)
            {
                retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.OleDb.OleDbDataAdapter, System.Data");
                if (retour == null) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.OleDb.OleDbDataAdapter, System.Data.OleDb");
                if (retour == null) retour = Nglib.APP.CODE.ReflectionTools.GetTypeByReflexion("System.Data.OleDb.OleDbDataAdapter, System.Data, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089"); // !!!
            }
