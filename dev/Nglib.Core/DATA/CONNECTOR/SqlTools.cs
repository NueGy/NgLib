...
namespace Nglib.DATA.CONNECTOR
{
    ...
    public class SqlTools
    {
        ...
        public static string CreateTableScript(System.Data.DataTable ret, bool temporary = false)
        {
            return CreateTableScript(ret.TableName, ret.Columns.ToList(), temporary);
        }

        public static string CreateTableScript(string tableName, List<System.Data.DataColumn> cols, bool temporary = false)
        {
            try
            {
                ...
                query.Append("CREATE ");
                if (temporary) query.Append("TEMP ");
                query.Append("TABLE ");
                query.Append(tableName);
                query.Append(" ( ");

                string virgule = " ";
                foreach (System.Data.DataColumn col in cols.Where(col => col != null))
                {
