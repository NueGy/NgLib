...
namespace Nglib.DATA.PARAMVALUES
{
    ...
    public class ParamValuesNode : DATA.ACCESSORS.IDataAccessor,  IComparable
    {
        ...
        /// </summary>
        public ParamValues datavalues_parent = null;


        public ParamValuesNode()
        {
        }


        public ParamValuesNode(string fullname)
        {
